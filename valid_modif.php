...
$req1 = "UPDATE contact SET nom = '$nom',  email= '$email' WHERE id=$id";
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                              ...
                              <h4 class="card-title">Modification faite avec succès</h4>
                                </div>
                           <div class="card-body table-full-width table-responsive">
                           	
                                    <table class="table table-hover table-striped">
                                    	<tr><td align="center"><a href="notif.php">Afficher les données </a></td></tr>
                                  </table>
